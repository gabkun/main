...
const About = () => {
  return (
    ...
    <div id="social" class="flex flex-wrap justify-start items-center gap-4">
      <a rel="noopener" target="_blank" href="https://github.com/gabkun" class="bg-gray-800 rounded-lg p-5 w-64 flex items-center gap-2 text-white">
      ...
      <a rel="noopener" target="_blank" href="https://www.linkedin.com/in/gabriel-malanday-18619b178/" class="bg-gray-800 rounded-lg p-5 w-64 flex items-center gap-2 text-white">
